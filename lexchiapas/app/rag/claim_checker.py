...
CLAIM_CHECKER_SYSTEM_PROMPT = (
    ...
    "hechos o consecuencias juridicas concretas y ESPECIFICAS que el "
    "usuario podria verificar o citar (numeros, plazos, requisitos, "
    "sanciones, procedimientos puntuales). "
    "NO cuentes como afirmacion material: saludos, conectores, el "
    "disclaimer final ('esto no sustituye asesoria legal'), frases que "
    "solo resumen o introducen lo que sigue, NI frases genericas de "
    "cobertura/variabilidad que no afirman un hecho concreto -- ej. 'las "
    "sanciones pueden variar segun las circunstancias del caso', 'depende "
    "de la gravedad', 'esto puede diferir caso por caso'. Estas ultimas son "
    "cobertura retorica, no una afirmacion verificable: NO las incluyas en "
    "\"claims\" aunque aparezcan en el texto.\n\n"
    "Cuidado con el error opuesto: una frase que SUENA a hedge pero en "
    "realidad afirma un HECHO CONCRETO especifico (un numero, un plazo, un "
    "porcentaje, una regla de calculo) SI es material y SI debe evaluarse -- "
    "ej. 'los recargos se calculan sobre el monto total del credito' o "
    "'el plazo es de cinco anos' son afirmaciones verificables aunque no "
    "mencionen la palabra exacta del fragmento; no las descartes solo "
    "porque conviven con lenguaje generico en la misma oracion.\n\n"
    ...
    "escrito en el fragmento, no por lo que suena plausible en un sistema "
    "legal tipico. "
